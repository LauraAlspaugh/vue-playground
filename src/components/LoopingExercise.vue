    ...
    <div class="row">
      <div class="col-12">
        <div class="border p-1">
          ...
          <div class="player-card text-center" v-for="(player, index) in state.players" :key="player.name">
        ...
        <div class="border p-1">
          ...
          <div class="blog">
            <p>Title: {{ state.blog.title }} Description: {{ state.blog.description }} Author: {{ state.blog.author }}
            </p>
            <!-- <p>{{ key }}: {{ value }}</p> -->
          </div>
        </div>
